...
void setupDynamixel(uint8_t dxl_id)
{
  ...
  if (dxl_comm_result != COMM_SUCCESS) {
    RCLCPP_ERROR(rclcpp::get_logger("read_write_node"), "Failed to set Counter-Clockwise Angle Limit.");
  } else {
    RCLCPP_INFO(rclcpp::get_logger("read_write_node"), "Succeeded to set Counter-Clockwise Angle Limit.");
  }
